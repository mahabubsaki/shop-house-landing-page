...
const homeProductsFeatured: {
    ...
    price: number,
        ...
        {
            category: 'Backpacks', discount: 10, image: ['https://i.ibb.co/pWkNb08/product-11.jpg', 'https://i.ibb.co/rsB4pkS/product-11-2.jpg'], isHot: true, name: 'Men Sports Travel Bag', price: 45, rating: 4
        }
    ];
